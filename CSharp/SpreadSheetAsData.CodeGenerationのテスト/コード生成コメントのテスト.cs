...
public sealed class コード生成コメントのテスト
{
    ...
    public void ブックスコープの単一セル定義名プロパティのコメントを生成します()
    {
        GeneratedCodeInspection
            ...
            .SummaryText()
            .Should().Be("定義名「main_cell」が表すセルの値を取得または設定します。");
    }
    ...
    public void ブックスコープの複数セル定義名プロパティのコメントを生成します()
    {
        GeneratedCodeInspection
            ...
            .SummaryText()
            .Should().Be("定義名「main_range」が表すセル範囲の値を取得または設定します。");
    }
    ...
    public void シートローカルの複数セル定義名プロパティのコメントを生成します()
    {
        GeneratedCodeInspection
            ...
            .SummaryText()
            .Should().Be("ワークシート「sales_data」の定義名「local_range」が表すセル範囲の値を取得または設定します。");
    }
}
